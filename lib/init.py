...
def has_exilium_conf():
    ...
    # ensure exilium_conf exists & readable
    #
    # if not, print a message stating that Exilium Core must be installed and
    # configured, including JSONRPC access in exilium.conf
    try:
